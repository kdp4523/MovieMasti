    ...
    try {
      ...
      if (data?.status) {
        data?.favoriteMoviesData?.forEach((m) => {
          // console.log(m); // Removed for cleaner console output
        ...
        <>
          <div className="movieDetailsContainer">
            <div className="detailsContainer">
              ...
              <div className="right">
                <h4>{`${
                  movieDetails?.movieName && typeof movieDetails.movieName === 'string' && movieDetails.movieName.length > 0
                    ? movieDetails.movieName[0].toUpperCase() + movieDetails.movieName.slice(1)
                    : 'Unknown Movie'
